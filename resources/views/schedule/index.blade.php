                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form action="{{ url('/schedule/createSchedule') }}" method="GET">{{ csrf_field() }}
                            <button type="submit" class="btn btn-primary"><i class="fa fa-btn fa-file-o"></i>Create Schedule</button>
                        </form>
                        </br>
                        <form action="{{ url('/schedule/requestSchedule') }}" method="GET">{{ csrf_field() }}
                            <button type="submit" class="btn btn-primary"><i class="fa fa-btn fa-file-o"></i>View Old Schedule</button>
                        </form>
                    </div>
                </div>
            </div>
