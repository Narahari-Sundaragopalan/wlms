                        ...
                        <div class="panel-heading" style="text-align: center; color: black">
                            ...
                            @if(Auth::check() && (Auth::user()->hasRole('admin')))
                                <div class="pull-right">
                                    <form action="{{ url('Supervisor/'.$supervisor->id) }}" method="POST"
                                          onsubmit="return ConfirmDelete();">{{ csrf_field() }}{{ method_field('DELETE') }}
                                        <button type="submit" id="delete-user-{{ $supervisor->id }}"
                            ...
                            <div class="table-responsive">
                                ...
                                <div>
                                    <div class="col-md-6 col-md-offset-5">
                                        <a href="{{route('Supervisor.edit',$supervisor->id)}}" class="btn btn-warning"
